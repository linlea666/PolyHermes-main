...
export const getVersionInfo = (): VersionInfo => {
  ...
  if (windowVersion) {
    return {
      ...
      githubRepoUrl: windowVersion.githubRepoUrl || 'https://github.com/linlea666/PolyHermes-main'
    }
  }
  ...
  return {
    ...
    githubRepoUrl: import.meta.env.VITE_APP_GITHUB_REPO_URL || 'https://github.com/linlea666/PolyHermes-main'
  }
}
