...
export interface CryptoTailStrategyDto {
  ...
  scalpSpotLeadEnabled?: boolean
  scalpSpotLeadSource?: string
  scalpSpotLeadMaxAgeMs?: number
  scalpSpotLeadFlipDistanceSigma?: string
  scalpSpotLeadWickVetoEnabled?: boolean
