...
[![GitHub](https://img.shields.io/badge/GitHub-linlea666%2FPolyHermes--main-blue?logo=github)](https://github.com/linlea666/PolyHermes-main)
...
适合当前定制版本：服务器从你的 GitHub 仓库拉代码，在服务器上用 Docker 构建并运行。
...
如果脚本提示已创建 `.env` 并退出，先检查 `.env` 中的数据库密码、`JWT_SECRET`、`ADMIN_RESET_PASSWORD_KEY` 等配置，然后再次执行：
...
curl -O https://raw.githubusercontent.com/linlea666/PolyHermes-main/main/docker-compose.prod.yml
curl -O https://raw.githubusercontent.com/linlea666/PolyHermes-main/main/docker-compose.prod.env.example
