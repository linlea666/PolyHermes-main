...
**重要**：只有通过 [GitHub Releases 页面](https://github.com/linlea666/PolyHermes-main/releases/new) 创建 release 时才会触发自动构建。
...
**创建步骤**：
1. 访问 [GitHub Releases 页面](https://github.com/linlea666/PolyHermes-main/releases/new)
...
1. 访问 [GitHub Releases 页面](https://github.com/linlea666/PolyHermes-main/releases)
2. 找到要删除的 release
3. 点击 "Delete" 按钮
...
- `GITHUB_REPO_URL`: GitHub 仓库 URL（默认：`https://github.com/linlea666/PolyHermes-main`）
...
**A:** 检查以下几点：
1. 确认是通过 [GitHub Releases 页面](https://github.com/linlea666/PolyHermes-main/releases/new) 创建的 release，而不是直接推送 tag
...
**步骤 1：访问 Releases 页面**
访问：https://github.com/linlea666/PolyHermes-main/releases/new
